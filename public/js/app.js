...
function removeCartFunction(cake) {
  axios.post("/remove-item", cake).then(function (res) {
    //Yo 
    cartCounter.innerText = res.data.totalQty;
    location.reload();
  });
...
(0,_stripe__WEBPACK_IMPORTED_MODULE_3__.initStripe)(); //Socket intigration
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register("/sw.js").then(function (reg) {
    ...
    return console.log("sw error", err);
  });
} //////////////////////////
//Hamburger
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51IbHSpSJVYgx7nr3ec5HljpyRw5mdet25XUIK7FBwGxprhxX81LLnfyesrwZv6LaOYNaKwoMo02dDGw8N7cH9eOO00Ur1kfhh5");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkzeeniesdelicatessen"] = self["webpackChunkzeeniesdelicatessen"] || [];
